class P43
{
	...
	public static void main(String[] args) 
	{
		...
		System.out.println("enter number of rows/outer array size:");
		int rowsSize = sc.nextInt();
		System.out.println("enter number of cols/inner array size:");
		int colsSize = sc.nextInt();
		elements = new int[rowsSize][colsSize];
		int t = 0, b = rowsSize - 1, left = 0, right = colsSize - 1;
		int dir = 0;
		/*
			0 => l -> r
			1 => t -> b
